...
rd2l_teams_soup = BeautifulSoup(requests.get("https://rd2l.gg/seasons/InTrqz3D1/divisions/Hkhg_uesz/teams", verify=False).content, "html.parser")
teams=[]
rd2l_base= "https://rd2l.gg"
team_tds = rd2l_teams_soup.findAll("td")
print('Grabbed Teams from RD2L')
